...
<body onload="load()"> 
    ...
    <footer id="footer" class="section__footer">
            <div class="copyright">
                <p>© 2021 All Rights Reserved Rajat</p>
            </div>
            ...
            <div class="follow">
                <div class="follow__icon">
                    ...
                    <a href="https://www.instagram.com/i_am_rajat1/" target="_newtab"><i class="fab fa-instagram-square"></i></a>
                    
                    <a href="https://github.com/Rajatb04" target="_newtab"><i class="fab fa-github-square"></i></a>
                    
                    <a href="https://www.youtube.com/channel/UCwSoKRR5yi8zZT5YoHbh_Hg" target="_newtab"><i class="fab fa-youtube-square" ></i></a>

                    <a href="https://www.facebook.com/rajat.baghel.73997/" target="_newtab"><i class="fab fa-facebook-square"></i></a>     
                </div>
            </div>
